...
public class DemoCircle {
	...
	public static void main(String[] args) {
		...
		System.out.println(c1.toString()); // Should print "Circle: centerX = 6.0 centerY = 6.0 radius = 6.0"
		
		// TODO print c2 with toString
		System.out.println(c2.toString()); // Should print "Circle: centerX = 6.0 centerY = 6.0 radius = 6.0"
